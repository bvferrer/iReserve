...
public partial class AdminRequestDetails : System.Web.UI.Page
{
    ...
    public void LoadRequestDetails()
    {
        ...
        if (result.Status.StatusCode == StatusCode.ForConfirmation)
        {
            Response.Redirect("ConfirmRequestDetails.aspx");
        }

        if (result.Status.StatusCode == StatusCode.ForCancellation)
        {
