...
public partial class CCAdminHome : System.Web.UI.Page
{
    ...
    public void RefreshCCAdminConfirmedGridView()
    {
        ...
        RetrieveCCRequestRecordsByStatusResult retrieveCCRequestRecordsByStatusResult = svc.RetrieveCCRequestRecordsByStatus(retrieveCCRequestRecordsByStatusRequest);
        ...
        {
            ccAdminConfirmedGridView.DataSource = retrieveCCRequestRecordsByStatusResult.CCRequestList;
    ...
    public void RefreshForSOAProcessingGridView()
    {
        ...
        {
            forSOAProcessingGridView.DataSource = retrieveCCRequestRecordsBySOAStatusResult.CCRequestList;
