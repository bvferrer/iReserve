<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
  CodeFile="CCAdminRequestDetails.aspx.cs" Inherits="CCAdminRequestDetails" %>
      ...
      <ContentTemplate>
        <div class="contentDiv">
          <div class="details_wrapper">
            <table>
              ...
              <tr>
                ...
                <td>
                  ...
                  <asp:LinkButton ID="viewHistoryLinkButton" runat="server" Text="View History"
                    OnClick="viewHistoryLinkButton_Click"></asp:LinkButton>
                </td>
              </tr>
              <tr>
                <td>
                  <strong>SOA Status</strong>
                </td>
                <td>
                  <asp:Label ID="soaStatusLabel" runat="server" Text=""></asp:Label>
                  <asp:LinkButton ID="viewSOAHistoryLinkButton" runat="server" Text="View History"
                    OnClick="viewSOAHistoryLinkButton_Click"></asp:LinkButton>
                </td>
              </tr>
              <tr>
                <td>
            ...
            <asp:HiddenField ID="soaStatusCodeHiddenField" runat="server" />
              ...
              <tr>
                <td>
                  <asp:Button ID="requestorCancelRequestButton" runat="server" CssClass="ButtonStyle"
                    ...
                    Enabled="true" />
                  <asp:Button ID="createSOAButton" runat="server" CssClass="ButtonStyle"
                    Text="Create SOA" OnClick="createSOAButton_Click" Visible="false"
                    Enabled="true" />
                  <asp:Button ID="viewSOAButton" runat="server" CssClass="ButtonStyle"
                    Text="View SOA" OnClick="viewSOAButton_Click" Visible="false"
                    Enabled="true" />
              ...
              <div class="historyformwrapper">
                ...
                <div class="formfieldsdiv">
                  <div>
                    ...
                    <asp:GridView ID="soaHistoryGridView" runat="server" AutoGenerateColumns="false" CssClass="historygrid">
                      <HeaderStyle BackColor="#507CD1" ForeColor="#FFFFFF" Font-Bold="true" />
                      <RowStyle BackColor="#EFF3FB"></RowStyle>
                      <Columns>
                        <asp:TemplateField>
                        ...
                        <asp:BoundField DataField="SOAStatusName" HeaderText="Status" />
                        <asp:BoundField DataField="DateProcessed" HeaderText="Date Processed" />
                        <asp:BoundField DataField="ProcessedBy" HeaderText="Processed By" />
                        <asp:BoundField DataField="Remarks" HeaderText="Remarks" />
                      </Columns>
