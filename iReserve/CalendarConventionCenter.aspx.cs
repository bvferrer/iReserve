...
public partial class CalendarConventionCenter : System.Web.UI.Page
{
  ...
  private void BindCostCenter()
  {
    try
    {
      ...
      CostCenter[] costCenter = svc.RetrieveCostCenter();
  ...
  protected void costCenterDropDownList_SelectedIndexChanged(object sender, EventArgs e)
  {
    ...
    BindSummaryGridView(); DisplayRequestSummaryModal();
  }
  public void DisplayRequestSummaryModal()
  {
