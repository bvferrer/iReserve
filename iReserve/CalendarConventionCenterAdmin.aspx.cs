  ...
  protected void hiddenButton_Click(object sender, EventArgs e)
  {
    ...
    if (inhAction.Value == "CELLCLICKED")
    {
      ...
      else
      {
        ...
        //  costCenterLabel.Text = retrieveCCRequestDetailsResult.CCRequest.ChargedCompanyCostCenter.CostCenterName;
        //}
        string costCenter = retrieveCCRequestDetailsResult.CCRequest.ChargedCompanyCostCenter.CostCenterName;
        chargedCompanyLabel.Text = retrieveCCRequestDetailsResult.CCRequest.CostCenterName;
        costCenterLabel.Text = costCenter != null ? costCenter : string.Empty;
