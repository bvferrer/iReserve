<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="CancelRequestDetails.aspx.cs" Inherits="CancelRequestDetails" %>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="cancelRequestButton" runat="server" CssClass="ButtonStyle" Text="Cancel Request"
                                        OnClick="cancelRequestButton_Click" />
                        ...
                        <asp:Panel ID="pnlpopup" runat="server" BackColor="White">
                            <div class="formwrapper">
                                <div class="formheaderdiv">
                                    <div class="bold">
                                        <asp:Label ID="headerLabel" runat="server" Text="Cancel Reservation Request"></asp:Label>
                                    </div>
                                </div>
