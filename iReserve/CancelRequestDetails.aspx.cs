...
public partial class CancelRequestDetails : System.Web.UI.Page
{
    ...
    private void CancelRequest()
    {
        ...
        {
            smessage = "The reservation request with Reference Number: " + referenceNumberHiddenField.Value + " has been successfully cancelled.";
