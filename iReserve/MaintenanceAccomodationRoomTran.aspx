<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="MaintenanceAccomodationRoomTran.aspx.cs" Inherits="MaintenanceAccomodationRoomTran" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentBody" Runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ConfirmNavigationMsgBox(statusID) {
            ...
            if (status != "V") {
                if (roomLocation.value != 0 || roomCode.value != "" || roomName.value != "" || roomDesc.value != "" || maxPerson.value != "" || rate.value != "") {
        ...
        function OnSucceeded(typeID) {
            ...
            var roomDesc = $get("<%=roomDescriptionTextBox.ClientID%>");
            var maxPerson = $get("<%=maxPersonNumericBox.ClientID%>");
            var ratePerDay = $get("<%=rateNumericBox.ClientID%>");
            var savingButton = $get("<%=saveButton.ClientID%>");
            ...
            <div class="fields_wrapper">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="roomNameTextBox" runat="server" Width="450px" MaxLength="30" CssClass="TextBoxStyle">
                            </asp:TextBox>
                        </td>
                    </tr>
                    <tr>
