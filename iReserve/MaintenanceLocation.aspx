<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="MaintenanceLocation.aspx.cs" Inherits="Location" %>

<asp:Content ID="Content1" ContentPlaceHolderID="contentBody" runat="Server">
    <asp:ScriptManager ID="ScriptManager" EnablePageMethods="true" runat="server" />
    <script language="javascript" type="text/javascript">
        var TotalRows;
        var locationRowIndex;
        // ================================================================================================================================================
        function GetLocationRowIndex(rowindex) {
            locationRowIndex = rowindex;
        }
        // ================================================================================================================================================
        function ConfirmDelete() {
            if ($get("<%=locationGridView.ClientID%>") != null) {
                if (locationRowIndex != null) {
                    var grid = $get('<%=locationGridView.ClientID%>');
                    var selectedLocationID = grid.rows[locationRowIndex].cells[1].innerText;
                    var selectedLocationCode = grid.rows[locationRowIndex].cells[2].innerText;
                    var selectedLocationName = grid.rows[locationRowIndex].cells[3].innerText;
                    var selectedLocationDesc = grid.rows[locationRowIndex].cells[4].innerText;
                    var selectedRecordDetails = selectedLocationCode + '-' + selectedLocationName;
                    var macAddress = $get("<%=macAddressHiddenField.ClientID%>");

                    if (confirm("Delete location: " + selectedRecordDetails + "?")) {
                        PageMethods.deleteLocation(3, parseInt(selectedLocationID), selectedLocationCode, selectedLocationName,
                                                selectedLocationDesc, true, macAddress.value, OnDeleted);
                    }
                    else {
        ...
        // ================================================================================================================================================
        function LocationTransaction(transactionID) {
            var transaction;
            ...
            if (transactionID == 1) {
                ...
                if ($get("<%=locationGridView.ClientID%>") != null) {
                    if (locationRowIndex != null) {
                        var grid = $get('<%=locationGridView.ClientID%>');
                        var selectedRecordNo = grid.rows[locationRowIndex].cells[1].innerText;
                        ...
                        location.replace("MaintenanceLocationTran.aspx?Param=" + transaction + selectedRecordNo + "");
                    }
                    else {
                        if (transactionID == 2) {
            ...
            <ContentTemplate>
                <div class="contentDiv">
                    ...
                    <div class="gridview_wrapper">
                        <asp:GridView ID="locationGridView" runat="server" OnPageIndexChanging="locationGridView_PageIndexChanging"
                            PageSize="5" DataKeyNames="LocationID" OnRowDataBound="locationGridView_RowDataBound"
                            OnDataBound="locationGridView_DataBound" AllowPaging="True" EnableViewState="False"
                            AllowSorting="True" AutoGenerateColumns="False" OnRowCreated="locationGridView_RowCreated">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="LocationDesc" HeaderText="Location Details"></asp:BoundField>
                            </Columns>
                            <PagerTemplate>
                            ...
                            <SelectedRowStyle BackColor="DarkOrange" Font-Bold="True" ForeColor="#333333"></SelectedRowStyle>
                                ...
                                <tr>
                                    <td>
                                        <input id="addButton" class="ButtonStyle" type="button" value="Add" runat="server"
                                            onclick="javascript:LocationTransaction(1)" />
                                        <input id="editButton" class="ButtonStyle" type="button" value="Edit" runat="server"
                                            onclick="javascript:LocationTransaction(2)" />
                                        ...
                                        <input id="viewButton" class="ButtonStyle" type="button" value="View" runat="server"
                                            onclick="javascript:LocationTransaction(3)" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
