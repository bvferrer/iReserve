<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="MaintenanceTrainingRoom.aspx.cs" Inherits="MaintenanceTrainingRoom" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentBody" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ConfirmDelete() {
            if ($get("<%=trainingRoomGridView.ClientID%>") != null) {
                if (roomRowIndex != null) {
                    var grid = $get('<%=trainingRoomGridView.ClientID%>');
        ...
        // ================================================================================================================================================
        function TrainingRoomTransaction(transactionID) {
            var transaction;
            ...
            if (transactionID == 1) {
                ...
                if ($get("<%=trainingRoomGridView.ClientID%>") != null) {
                    if (roomRowIndex != null) {
                        ...
                        location.replace("MaintenanceTrainingRoomTran.aspx?Param=" + transaction + selectedRecordNo + "");
                    }
                    else {
                        if (transactionID == 2) {
            ...
            <ContentTemplate>
                <div class="contentDiv">
                    ...
                    <div class="gridview_wrapper">
                        <asp:GridView ID="trainingRoomGridView" runat="server" OnPageIndexChanging="trainingRoomGridView_PageIndexChanging"
                            PageSize="5" DataKeyNames="TRoomID" OnRowDataBound="trainingRoomGridView_RowDataBound"
                            OnDataBound="trainingRoomGridView_DataBound" AllowPaging="True" EnableViewState="False"
                            AllowSorting="True" AutoGenerateColumns="False" OnRowCreated="trainingRoomGridView_RowCreated">
                            <RowStyle BackColor="#EFF3FB" Wrap="true"></RowStyle>
                            <Columns>
                                <asp:CommandField ShowSelectButton="True" ButtonType="button">
                                    <ItemStyle CssClass="gridviewselect" />
                                </asp:CommandField>
                                <asp:BoundField DataField="TRoomID" HeaderText="Room ID">
                                ...
                                <asp:BoundField DataField="TRoomCode" HeaderText="Room Code"></asp:BoundField>
                                <asp:BoundField DataField="TRoomName" HeaderText="Room Name"></asp:BoundField>
                                <asp:BoundField DataField="TRoomDesc" HeaderText="Room Details"></asp:BoundField>
                            </Columns>
                            <PagerTemplate>
                                ...
                                <tr>
                                    <td>
                                        <input id="addButton" class="ButtonStyle" type="button" value="Add" runat="server"
                                            onclick="javascript:TrainingRoomTransaction(1)" />
                                        <input id="editButton" class="ButtonStyle" type="button" value="Edit" runat="server"
                                            onclick="javascript:TrainingRoomTransaction(2)" />
                                        ...
                                        <input id="viewButton" class="ButtonStyle" type="button" value="View" runat="server"
                                            onclick="javascript:TrainingRoomTransaction(3)" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
