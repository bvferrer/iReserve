<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportAccomodationRoom.aspx.cs" Inherits="ReportAccomodationRoom" %>
    ...
    <asp:UpdatePanel ID="calendarUpdatePanel" runat="server">
        <ContentTemplate>
            <div class="reportContainer">
                <div class="innerNav">
                    <span>Accomodation Room Reservation Report</span>
                </div>
                <div>
                    <span>Status :</span>
                ...
                <div class="reportgridview_wrapper">
                    <asp:GridView ID="reportGridView" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NumberOfNights" HeaderText="Number Of Nights" />
