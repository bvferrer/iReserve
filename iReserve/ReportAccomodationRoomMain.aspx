<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="ReportAccomodationRoomMain.aspx.cs" Inherits="ReportAccomodationRoomMain" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentBody" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GenerateReport() {
            ...
            if (selectedDateFrom > selectedDateTo) {
                ...
                window.open('ReportAccomodationRoom.aspx?param1=' + selectedDateFrom + '&param2=' + selectedDateTo + '&param3=' + selectedStatus.value, '', 'top=' + ((screen.height) * 0.05) + ',left=' + ((screen.width) * 0.1) + ',resizable=1,scrollbars=yes,width=' + ((screen.width) * 0.8) + ',height=' + ((screen.height) * 0.8) + '');
                location.reload();
            }
            //            }
        }    
    ...
    <div class="mainDiv">
        <h2 class="header">
            <span>Accomodation Room Reservation Requests Report </span>
        </h2>
