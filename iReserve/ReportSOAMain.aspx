<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="ReportSOAMain.aspx.cs" Inherits="ReportSOAMain" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function GenerateReport() {
            ...
            if (selectedDateFrom > selectedDateTo) {
                ...
                window.open('ReportSOA.aspx?param1=' + selectedDateFrom + '&param2=' + selectedDateTo, '', 'top=' + ((screen.height) * 0.05) + ',left=' + ((screen.width) * 0.1) + ',resizable=1,scrollbars=yes,width=' + ((screen.width) * 0.8) + ',height=' + ((screen.height) * 0.8) + '');
                location.reload();
            }
        }    
    </script>
