...
public partial class ReportTrainingRoom : System.Web.UI.Page
{
  ...
  public void LoadReportGridView()
  {
    ...
    RetrieveTrainingRoomRequestReportResult retrieveTrainingRoomRequestReportResult;

    try
    {
      retrieveTrainingRoomRequestReportResult = svc.RetrieveTrainingRoomRequestReport(retrieveTrainingRoomRequestReportRequest);
    }
    catch (Exception ex)
    {
    ...
    else
    {
      ...
      foreach (TrainingRoomRequestReport record in retrieveTrainingRoomRequestReportResult.TrainingRoomRequestReportList)
      {
        ...
        dr["TRoomName"] = record.TRoomName;
        dr["NumberOfPartition"] = record.NumberOfPartition;
        dr["StartDate"] = record.StartDate;
        dr["EndDate"] = record.EndDate;
        dr["NumberOfDays"] = record.NumberOfDays;
