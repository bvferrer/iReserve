<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="RequestDetails.aspx.cs" Inherits="RequestDetails" %>
    ...
    <div class="mainDiv">
        ...
        <asp:UpdatePanel ID="UpdatePanel" runat="server" ChildrenAsTriggers="true">
                ...
                <div class="contentDiv">
                    ...
                    <div class="button_wrapper">
                        <table>
                            <tr>
                                <td>
                                    <%--<asp:Button ID="cancelRequestButton" runat="server" CssClass="ButtonStyle" Text="Cancel Request"
                                        OnClick="cancelRequestButton_Click" Visible="false" Enabled="true" />--%>
                                    <asp:Button ID="requestorCancelRequestButton" runat="server" CssClass="ButtonStyle" Text="Cancel Request"
                                        OnClick="requestorCancelRequestButton_Click" Visible="false" Enabled="true" />
                        ...
                        <asp:Panel ID="pnlpopup" runat="server" BackColor="White">
                            <div class="formwrapper">
                                <div class="formheaderdiv">
                                    <div class="bold">
                                        <asp:Label ID="headerLabel" runat="server" Text="Cancel Confirmed Reservation Request"></asp:Label>
                                    </div>
                                </div>
                                <div class="formfieldsdiv">
                                    <div>
                                        ...
                                        <asp:RegularExpressionValidator ID="approvalRegularExpressionValidator" runat="server"
                                            ...
                                            ValidationGroup="form" ErrorMessage="Please select valid file type: .msg|.doc|.docx|.jpg|.png|.gif"
                                        ...
                                        <asp:CustomValidator ID="approvalCustomValidator" runat="server" ForeColor="Red"
                                            Font-Size="10px" SetFocusOnError="true" Display="Dynamic" ErrorMessage="Allowed attachment file size is up to 3MB only."></asp:CustomValidator>
                                    </div>
                                    <div>
                        ...
                        <asp:Panel ID="pnlpopup3" runat="server" BackColor="White">
                            <div class="formwrapper">
                                ...
                                <div class="formfieldsdiv">
                                    <div>
                                        <span class="bold">Remarks</span><br />
                                        <asp:TextBox ID="remarksTextBox2" runat="server" Height="50px" CssClass="TextBoxStyle"
                                            Width="300px" MaxLength="100" ValidationGroup="form2" TextMode="MultiLine"></asp:TextBox><br />
                                        <asp:RequiredFieldValidator ID="remarksRequiredFieldValidator2" runat="server" SetFocusOnError="true"
                                            Display="Dynamic" ControlToValidate="remarksTextBox2" ErrorMessage="Remarks is required."
                                            ValidationGroup="form2" ForeColor="Red" Font-Size="10px"></asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="remarksLengthValidator2" runat="server"
                                            SetFocusOnError="true" Display="Dynamic" ControlToValidate="remarksTextBox2" ValidationExpression="^.{1,100}$"
                                            ValidationGroup="form2" ErrorMessage="Remarks is up to 100 characters only."
                                            ForeColor="Red" Font-Size="10px"></asp:RegularExpressionValidator>
                                        <asp:RegularExpressionValidator ID="remarksRegularExpressionValidator2" runat="server"
                                            SetFocusOnError="true" Display="Dynamic" ControlToValidate="remarksTextBox2" ValidationExpression="^[0-9A-Za-z\.,\-'\s?&)(/]+$"
                                            ValidationGroup="form2" ErrorMessage="The only accepted special characters are .,-')(?&/"
                                            ForeColor="Red" Font-Size="10px"></asp:RegularExpressionValidator>
                                    </div>
                                    <div>
                                        <asp:Button ID="submitButton2" runat="server" Text="Submit" Width="80px" CausesValidation="true"
                                            ValidationGroup="form2" OnClick="submitButton2_Click" OnClientClick="ButtonLoading2(this)"
                                            UseSubmitBehavior="false" />
                                        <asp:Button ID="cancelButton2" runat="server" Text="Cancel" Width="80px" OnClick="cancelButton2_Click"
                                            CausesValidation="false" />
                                    </div>
                                </div>
                            </div>
            ...
            <Triggers>
                ...
                <asp:PostBackTrigger ControlID="submitButton2" />
            </Triggers>
        </asp:UpdatePanel>
    </div>
</asp:Content>
