...
/// <summary>
/// Summary description for RetrieveAccomodationRoomRecordDetailsResult
/// </summary>
public class RetrieveAccomodationRoomRecordDetailsResult : IBaseResult
{
	public RetrieveAccomodationRoomRecordDetailsResult()
	{
		//
