...
/// <summary>
/// Summary description for RetrieveCCRequestRecordsByStatusResult
/// </summary>
public class RetrieveCCRequestRecordsByStatusResult : IBaseResult
{
	public RetrieveCCRequestRecordsByStatusResult()
	{
		//
