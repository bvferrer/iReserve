      ...
      using (SqlCommand sqlCommand = new SqlCommand(StoredProcedures.RetrieveTrainingRoomRequestReport, sqlConnection))
      {
        ...
        using (SqlDataReader rd = sqlCommand.ExecuteReader())
        {
          while (rd.Read())
          {
            ...
            trainingRoomRequestReport.ChargedCompanyCostCenter.CostCenterName = RDFramework.Utility.Conversion.SafeReadDatabaseValue<string>(rd["fld_ChargedCompanyCostCenterName"]);
